...
function upload_file_oracle($bucket_name, $folder_name = '', $file_name)
{
    ...
    $file_url = "https://objectstorage.ap-sydney-1.oraclecloud.com/p/ZYqQBjjbSSY1bvl9wsm-Si03X8qoGR0q5xFjx_OxF1VL16WdZMvQXZ-CMPNs59VA/n/sd8xvmwjd9sl/b/alwi-bucket/o/{$keyname}";
    try {
        $s3->putObject(array(
            'Bucket' => $bucket_name,
            'Key' => $keyname,
	...
	{
		$bucket_name='alwi-bucket';
		$folder_name='filegambar';
